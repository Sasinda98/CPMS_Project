...
public class stockLowAdapter extends BaseAdapter {

    Context c;
    ArrayList<inventory_item_Bean> stockLowItems;

    public stockLowAdapter(Context c, ArrayList<inventory_item_Bean> stockLowItems) {
        this.c = c;
        this.stockLowItems = stockLowItems;
    }

    @Override
    public int getCount() {
        return stockLowItems.size();
    }

    @Override
    public Object getItem(int i) {
        return stockLowItems.get(i);
    }
